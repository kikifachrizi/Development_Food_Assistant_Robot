...
// double kp2 = -0.00036353;
// double ki2 = -0.0012954;
// double kd2 = 0;

// double kp3 = -0.00038777;
// double ki3 = -0.0015316;
// double kd3 = 0;
...
void test_pid(){
    ...
    while (t.read_ms() < 10000) {
        double mtrB = m2.pid_speed(100, kp2, ki2,kd2, eB.getRPM(), t_pid.read_high_resolution_us());
        double mtrC = m3.pid_speed(-100, kp3, ki3,kd3, eC.getRPM(), t_pid.read_high_resolution_us());
