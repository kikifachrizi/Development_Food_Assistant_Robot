...
PID_lib::PID_lib(PinName direction1, PinName direction2, PinName pulseWidth) : dir1(direction1), dir2(direction2), pwm(pulseWidth){    
    dir1 = 0;
    dir2 = 0;
    pwm = 0;
...
//         pwm.period(0.010);
//         pwm = compute(target_, kp_, ki_, kd_,angle_);
